...
export function EventFormModal({ event, isSaving, errorMsg, onClose, onSubmit }: Props) {
  ...
  return (
    <BottomSheet
      ...
      description="Mantenha a informação curta e clara para os alunos."
      onClose={onClose}
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <label className="form-label">
          ...
          <textarea
            ...
            placeholder="Detalhes rápidos sobre o evento"
        ...
        <div className="sticky bottom-0 -mx-5 bg-[var(--app-surface)] px-5 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-18px_32px_rgba(0,0,0,0.05)]">
          <button
            disabled={isSaving}
